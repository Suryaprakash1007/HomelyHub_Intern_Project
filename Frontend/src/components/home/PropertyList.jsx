...
const PropertyList = () => {
  ...
  // ✅ Safe defaults so you don’t get "undefined.length"
  const { properties = [], totalProperties = 0, loading, error } = useSelector(
  ...
  useEffect(() => {
    dispatch(propertyActions.updateSearchParams(currentPage));
